...
if(@info='' or @infos='')
begin
   print 'los datos no pueden ser nulos'
end
else
begin
     set @resultado=dbo.CifradoPlayfair(@info,
  @infos) 
  print @resultado
end


Ejecutar 'ahaudjhjkdajkdjkad el bicho syuiiiiiiiiiiiiiiiiiii', 'sdaudhoduwn elbichopelao'





create procedure EjecutarPC
@info nvarchar(50),
@infos nvarchar(50)
as
declare @resultado as nvarchar(max)
...
--1. Modificar el Procedure Ejecutar para que sea
-- flexible

-- 2.- Cifrar Con Playfair el algoritmo de Cesar
-- Cifra sobre cifra
set @resultado=dbo.CifradoPlayfair(@info,
  @infos) 
  print @resultado
